    ...
    public partial class Form1 : Form
    {
        ...
        {            
            ...
            {                
                ...
                cmd.CommandText = "SELECT Id, StudentName, FathersName, Institute.InstituteId, DateOfBirth, CourseFee, Course.CourseId, ImageData FROM Student join Course on Student.CourseId=Course.CourseId join Institute on Student.InstituteId=Institute.InstituteId";
                con.Open();
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    obj.InstituteId = Convert.ToInt32(dt.Rows[i]["InstituteId"].ToString());
        ...
        private void btnInstituteInfo_Click(object sender, EventArgs e)
        {
            OpenChiledFormInPanel(new InstituteFrm());
        }
    }
}
